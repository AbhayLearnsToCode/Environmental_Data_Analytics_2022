...
wind_data_clean <- 
  wind_data %>% 
  mutate( AWND.clean = zoo::na.approx(AWND) ) #packagename::function to (column)
...
# In tsa, you need to REPLACE your NAs. Do not omit them. you need to replace them using na.approx
...
wind_data_ts <- ts(wind_data_clean$AWND.clean,
                   ...
                   frequency=12) 
# defining first year and month is relevant for tsa
