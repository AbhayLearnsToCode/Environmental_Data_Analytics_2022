...
#rep creates a sequence of numbers
...
#Use lapply to apply the scrape function - repeat fn for stipulated range
the_dfs <- lapply(X = the_years,
                  FUN = scrape.it,
                  the_facility=my_facility)

#OR, use purrr's map function - mapping values onto a function
