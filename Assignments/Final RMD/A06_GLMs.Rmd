...
```{r setup}
#1
Chemistry_Data_Raw <- read.csv("./Data/Raw/NTL-LTER_Lake_ChemistryPhysics_Raw.csv", stringsAsFactors = FALSE)
...
to level off. The standard error of the regression line increases past this point, 
about 8 meters' depth.
