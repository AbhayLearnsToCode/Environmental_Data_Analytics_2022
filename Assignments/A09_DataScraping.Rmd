...
ggplot(the_dataframe, aes(x=Date, y=Max.Withdrawals))+
  geom_line(color="red")+
  labs(title='Max Withdrawals', subtitle= "Durham, 2020",y="Max Daily Withdrawals (Gallons, Millions)", x="Month, Year")
...
url.name <- paste0('https://www.ncwater.org/WUDC/app/LWSP/report.php?', 'pwsid=', the_pwsid, '&year=', the_year)
url.name
...
ggplot(the_dataframe, aes(x=Date, y=Max.Withdrawals))+
  ...
  labs(title='Max Withdrawals', subtitle= paste(water.system.name,the_year),y="Max Daily Withdrawals (Gallons, Millions)", x="Month, Year")
...
ggplot(the_df1, aes(x=Date, y=Max.Withdrawals))+
  ...
  geom_smooth(method="loess",se=FALSE) +
  labs(title='Max Withdrawals', subtitle= paste(the_df1$Water.System.Name,the_df1$Year),y="Max Daily Withdrawals (Gallons, Millions)", x="Month, Year")
...
ggplot(the_df2, aes(x=Date, y=Max.Withdrawals))+
  geom_line(color="darkgreen")+
  geom_smooth(method="loess",se=FALSE) +
  labs(title='Max Withdrawals', subtitle= paste(the_df2$Water.System.Name,the_df2$Year),y="Max Daily Withdrawals (Gallons, Millions)", x="Month, Year")
...
plot_combined <-
  ...
  geom_line()+
  labs(title='Max Withdrawals', subtitle= "Asheville and Durham",y="Max Daily Withdrawals (Gallons, Millions)", x="Month, Year")
...
#Plotting as it is allegedly fun and rewarding
ggplot(the_df,aes(x=Date,y=Max.Withdrawals)) + 
  geom_line() + 
  geom_smooth(method=lm,se=FALSE)+
  labs(title='Max Daily Usage', subtitle= "Asheville (2010-2019)",y="Max Daily Withdrawals (Gallons, Millions)", x="Month, Year")
```

>Question: Just by looking at the plot (i.e. not running statistics), does Asheville have a trend in water usage over time?
An LM line indicates a downward trend in water usage in Asheville.
