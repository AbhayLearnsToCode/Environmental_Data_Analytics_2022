...
#Generating boxplots for temp, tp and tn. 
PeterPaulTemp <-
...
outliers, were consistently higher in Peter lake: but there was no data on this
for Octobers and Novembers, unlike temperature data. We therefore cannot 
establish if the trend shifted in these months.
